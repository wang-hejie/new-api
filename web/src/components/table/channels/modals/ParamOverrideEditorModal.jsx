...
const DEFAULT_RETURN_ERROR_CODE_PLACEHOLDER = 'forced_bad_request';
const DEFAULT_RETURN_ERROR_TYPE_PLACEHOLDER = 'invalid_request_error';
const DEFAULT_PRUNE_TYPE_PLACEHOLDER = 'redacted_thinking';
const DEFAULT_FIELD_PATH_PLACEHOLDER = 'type';
const DEFAULT_SYNC_FROM_KEY_PLACEHOLDER = 'session_id';
const DEFAULT_SYNC_TO_KEY_PLACEHOLDER = 'prompt_cache_key';
const DEFAULT_CONDITION_PATH_PLACEHOLDER = 'model';
const DEFAULT_CONDITION_VALUE_PLACEHOLDER = 'gpt';
                                ...
                                mode === 'return_error' && returnErrorDraft ? (
                                        ...
                                        >
                                          ...
                                          <Col xs={24} md={8}>
                                            ...
                                            <Input
                                              ...
                                              placeholder={
                                                DEFAULT_RETURN_ERROR_CODE_PLACEHOLDER
                                              }
                                              onChange={(nextValue) =>
                                                updateReturnErrorDraft(
                                                  selectedOperation.id,
                                          ...
                                          <Col xs={24} md={8}>
                                            ...
                                            <Input
                                              ...
                                              placeholder={
                                                DEFAULT_RETURN_ERROR_TYPE_PLACEHOLDER
                                              }
                                              onChange={(nextValue) =>
                                                updateReturnErrorDraft(
                                                  selectedOperation.id,
                                  ...
                                  >
                                    ...
                                    <Input
                                      ...
                                      placeholder={
                                        DEFAULT_PRUNE_TYPE_PLACEHOLDER
                                      }
                                      onChange={(nextValue) =>
                                        updatePruneObjectsDraft(
                                          selectedOperation.id,
                                                  ...
                                                  <Row gutter={8}>
                                                    <Col xs={24} md={9}>
                                                      ...
                                                      <Input
                                                        value={rule.path}
                                                        placeholder={
                                                          DEFAULT_FIELD_PATH_PLACEHOLDER
                                                        }
                                                        onChange={(nextValue) =>
                                                          updatePruneRule(
                                                            selectedOperation.id,
                                    ...
                                    <Col xs={24} md={12}>
                                      ...
                                      <div className='flex gap-2'>
                                        ...
                                        <Input
                                          ...
                                          placeholder={
                                            DEFAULT_SYNC_FROM_KEY_PLACEHOLDER
                                          }
                                          onChange={(nextKey) =>
                                            updateOperation(
                                              selectedOperation.id,
                                    ...
                                    <Col xs={24} md={12}>
                                      ...
                                      <div className='flex gap-2'>
                                        ...
                                        <Input
                                          ...
                                          placeholder={
                                            DEFAULT_SYNC_TO_KEY_PLACEHOLDER
                                          }
                                          onChange={(nextKey) =>
                                            updateOperation(
                                              selectedOperation.id,
                                            ...
                                            <Row gutter={12}>
                                              <Col xs={24} md={10}>
                                                ...
                                                <Input
                                                  ...
                                                  placeholder={
                                                    DEFAULT_CONDITION_PATH_PLACEHOLDER
                                                  }
                                                  onChange={(nextValue) =>
                                                    updateCondition(
                                                      selectedOperation.id,
                                              ...
                                              <Col xs={24} md={6}>
                                                ...
                                                <Input
                                                  ...
                                                  placeholder={
                                                    DEFAULT_CONDITION_VALUE_PLACEHOLDER
                                                  }
                                                  onChange={(nextValue) =>
                                                    updateCondition(
                                                      selectedOperation.id,
